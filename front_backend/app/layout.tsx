                ...
                <div className="translation-overlay">
                    ...
                    {translationState === 'result' && (
                        <div className="result-container">
                            ...
                            <button className="result-close-btn" onClick={() => setTranslationState('idle')}>닫기</button>
                        </div>
                    )}
                </div>
            )}
                    ...
                    {translationState === 'audio_result' && (
                        <>
                            <div className="audio-result-wrapper">
                                <div className="audio-result-card">
                                    <div className="audio-alert-badge">
                                        ...
                                        <div className="audio-alert-text">🚨 {mockAudioData.title}</div>
                                    </div>
                            ...
                            <div className="audio-bottom-actions">
                                <button className="audio-action-btn audio-btn-primary" onClick={() => setTranslationState('audio_idle')}>다시 사용하기</button>
                                <button className="audio-action-btn audio-btn-secondary" onClick={() => setTranslationState('idle')}>닫기</button>
                            </div>
                        </>
                    )}
                </div>
